/**
 ...
 Computes simple bit operations.
 */
...
//        printf("false\n");
    ...
    unsigned short set = 0x0080;
    unsigned short clear = 0xFF7F;
...
/**
 Program starting point, Driver Class
 @return Program Exit Sucess.
 */
int main()
{
